defmodule Pento.Game.Pentomino do
  ...
  def rotate(pento), do: rotate(pento, :clockwise)

  def rotate(%{rotation: degrees} = p, :clockwise) do
    %{p | rotation: rem(degrees + 90, 360)}
  end

  def rotate(%{rotation: degrees} = p, :counterclockwise) do
    %{p | rotation: rem(degrees + 270, 360)}
  end
